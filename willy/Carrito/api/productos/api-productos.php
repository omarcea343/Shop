...
if(isset($_GET['categoria'])){
    ...
    if($categoria == ''){
        echo json_encode(['statuscode' => 400, 'reponse' => 'No existe esa categoria']);
    }else{
        $productos = new Productos();
        $items = $productos->getItemsByCategory($categoria);
        
        echo json_encode(['stauscode' => 200, 'items'=> $items]);
        ...
        echo json_encode(['stauscode' => 400, 'response'=> 'No hay accion']);
    }
}
?>